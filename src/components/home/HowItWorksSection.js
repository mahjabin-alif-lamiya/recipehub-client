...
export default function HowItWorksSection() {
  return (
    <section className="mx-auto max-w-6xl px-5 py-16">
      <h2 className="font-display text-2xl">How RecipeHub works</h2>

      <div className="mt-8 grid gap-8 sm:grid-cols-3">
        {steps.map((step, i) => (
          <div key={step.title} className="border-l-2 border-herb-500 pl-5">
            <p className="font-display text-3xl text-herb-500">{i + 1}</p>
